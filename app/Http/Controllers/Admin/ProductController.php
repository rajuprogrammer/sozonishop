...
class ProductController extends Controller
{
    ...
    public function GetShip($shiping){
        $cat = DB::table('settings')->first();
        return json_encode($cat);
    }
    ...
    public function store(Request $request){
        ...
        $data['wide_banner']=$request->wide_banner;
        $data['new_product']=$request->new_product;
        $data['featured_product']=$request->featured_product;
        $data['newarivals_product']=$request->newarivals_product;
    ...
    public function Inactive($id){
        ...
        $notification=array(
                    'messege'=>'Successfully Product Inactived',
                    'alert-type'=>'success'
                );
     ...
     public function Active($id){
        ...
        $notification=array(
                    'messege'=>'Successfully Product Aactived',
                    'alert-type'=>'success'
                );
        return Redirect()->back()->with($notification);
    }
    ...
    public function UpdateProductWithoutPhoto(Request $request,$id){
        ...
        if ($update) {
            ...
            $notification=array(
                    'messege'=>'Nothig to  Product Deleted',
                    'alert-type'=>'success'
                );
            return Redirect()->route('all.product')->with($notification);
        }
    ...
    public function UpdateProductPhoto(Request $request,$id){
        ...
        if ($request->has('image_one')) {
            ...
            $notification=array(
                    'messege'=>'Image 1 Product Updated',
                    'alert-type'=>'success'
                );
            return Redirect()->route('all.product')->with($notification);
        }
        if ($request->has('image_two')) {
            ...
            DB::table('products')->where('id',$id)->update($data);
            $notification=array(
                    'messege'=>'Image 2 Product Updated',
                    'alert-type'=>'success'
                );
            return Redirect()->route('all.product')->with($notification);
        }
        if ($request->has('image_three')) {
            ...
            DB::table('products')->where('id',$id)->update($data);
            $notification=array(
                    'messege'=>'Image 3 Product Updated',
                    'alert-type'=>'success'
                );
            return Redirect()->route('all.product')->with($notification);
        }
        ...
        if ($request->has('image_one') && $request->has('image_two')) {
            ...
            DB::table('products')->where('id',$id)->update($data);
            $notification=array(
                    'messege'=>'Image one & Two Product Updated',
                    'alert-type'=>'success'
                );
            return Redirect()->route('all.product')->with($notification);
        ...
        if ($request->has('image_one') && $request->has('image_two') && $request->has('image_three')) {
            ...
            DB::table('products')->where('id',$id)->update($data);
            $notification=array(
                    'messege'=>'All Image Product Updated',
                    'alert-type'=>'success'
                );
            return Redirect()->route('all.product')->with($notification);
        }
