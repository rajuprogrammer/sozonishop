...
<html lang="en">
  <head>
    ...
    <!-- Meta -->
    <meta name="description" content="Coder Fast 24 Created This Admin Panel">
    <meta name="author" content="ThemePixels">

    <title>Ecommer Website Admin Panel For CoderFast 24</title>
  ...
  <body>
    ...
    @else
     <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href=""><i class="icon ion-android-star-outline"></i> CoderFast24</a></div>
    <div class="sl-sideleft">
      <div class="sl-sideleft-menu">
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{route('admin.cupon')}}" class="nav-link">Coupons</a></li>
        </ul>
        @else
        @endif
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{ route('postcategory') }}" class="nav-link">Post Category</a></li>
        ...
        <ul class="sl-menu-sub nav flex-column">
            ...
            <li class="nav-item"><a href="{{ route('admin.request.allreturn') }}" class="nav-link">All Return</a></li>
        </ul>
        @else
        @endif
        ...
        <ul class="sl-menu-sub nav flex-column">
            ...
            <li class="nav-item"><a href="{{ route('admin.contact.allmessage') }}" class="nav-link">All Message</a></li>
        </ul>
        @else
        @endif
        ...
        <ul class="sl-menu-sub nav flex-column">
              ...
              <li class="nav-item"><a href="{{ route('admin.developer.setting') }}" class="nav-link">Create Developer</a></li>
              <li class="nav-item"><a href="{{ route('admin.all.developer') }}" class="nav-link">All Developer</a></li>
