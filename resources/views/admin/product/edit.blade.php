        ...
        <div class="card pd-20 pd-sm-40">
          ...
          <form action="{{ url('update/product/withoutphoto/'.$product->id) }}" method="post">
              ...
              <div class="col-lg-12">
                <div class="form-group">
                  <label class="form-control-label">Product Description<span class="tx-danger">*</span></label>
                   <textarea class="form-control" id="summernote" name="product_description">
            ...
            <span>Main Slider</span>
              ...
              <div class="col-lg-4">
                <label class="ckbox">
            <input type="checkbox" name="hot_deals" value="1" <?php if ($product->hot_deals == 1) {
              echo "checked";
            } ?> >
            <span>Hot Deal</span>
          </label>
            ...
            <span>Special Offer</span>
              ...
              <div class="col-lg-4">
                <label class="ckbox">
            <input type="checkbox" name="special_deals" value="1" <?php if ($product->special_deals == 1) {
              echo "checked";
            } ?> >
            ...
            <span>Best Seller</span>
              ...
              <div class="col-lg-4">
                <label class="ckbox">
                  <input type="checkbox" name="wide_banner" value="1" <?php if ($product->wide_banner == 1) {
              echo "checked";
            } ?> >
              ...
              <div class="col-lg-4">
                <label class="ckbox">
                  <input type="checkbox" name="new_product" value="1" <?php if ($product->new_product == 1) {
              echo "checked";
            } ?> >
              ...
              <div class="col-lg-4">
                <label class="ckbox">
                  <input type="checkbox" name="featured_product" value="1" <?php if ($product->featured_product == 1) {
              echo "checked";
            } ?> >
              ...
              <div class="col-lg-4">
                <label class="ckbox">
                  <input type="checkbox" name="newarivals_product" value="1" <?php if ($product->newarivals_product == 1) {
              echo "checked";
            } ?> >
