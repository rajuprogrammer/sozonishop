      ...
      <div class="sl-pagebody">
          ...
          <div class="form-layout">
            <div class="row mg-b-25">
              ...
              <div class="col-lg-4">
               ...
               <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="address"  required="" value="{{ $setting->address }}">
                </div>
              </div><!-- col-4 -->
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="rss"  required="" value="{{ $setting->rss }}">
                </div>
              </div><!-- col-4 -->
                <div class="col-lg-4">
                <div class="form-group">
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  <label class="form-control-label">Google Plus Link<span class="tx-danger">*</span></label>
                  <input class="form-control" type="text" name="google_plus"  required="" value="{{ $setting->google_plus }}">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-4">
                <div class="form-group">
