 ...
 -->
                ...
                <div class="col-md-6 col-sm-6 create-new-account">
                    ...
                    <div class="sing_one">
                        ...
                        <form class="register-form outer-top-xs" role="form" action="{{ route('rocket.charge') }}" method="post">
                            @csrf
                            ...
                            <div class="" id="bkash1">
                                <div class="jumbotron">
                                    ...
                                    <div class="form-group">
                                <ul class="logos_list">
                                    <li> <img src="{{ asset('public/frontend/images/rocket.png') }}" style="width: 100px; height: 60px;"></li>
                                 </ul>
                                    ...
                                    <span>Rocket Personal Number : 017402105469</span><br><br>
